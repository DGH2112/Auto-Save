object fmDIASParentFrame: TfmDIASParentFrame
  Left = 0
  Top = 0
  Width = 436
  Height = 555
  ...
  object lblInformation: TMemo
    ...
    Lines.Strings = (
        ...
        'DGH IDE Auto Save is a RAD Studio plug-in for periodically savin' +
        'g your'
      'files while you work.'
      ''
      'Copyright (C) 2019  David Hoyle '
      '(https://github.com/DGH2112/Auto-Save/)'
      ''
